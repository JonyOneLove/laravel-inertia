...
const deleteContractor = (id) => {
    router.delete(`/dashboard/contractors/${id}`);
};
</script>
        ...
        <table class="w-full border border-gray-200">
            <thead>
                ...
                >
                    ...
                    <td class="text-center">Orders Sum</td>
            ...
            <tbody>
                ...
                >
                    ...
                    <td class="font-medium text-center">{{ contractor.orders.length ?? 0 }}</td>
                    <td class="font-medium text-center">{{ contractor.orders_sum }}</td>
                    ...
                    <td>
                        <div class="flex justify-center items-center">
                            <span
                                class="text-center inline-block w-20 group-hover:hidden"
                            >
                                12/01/22
                            </span>
                            <div
                            ...
                            >
                                <Link
                                    :href="
                                        route('contractors.edit', contractor.id)
                                    "
