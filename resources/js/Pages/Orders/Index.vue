...
const deleteOrder = (id) => {
    router.delete(`/dashboard/orders/${id}`);
};
...
<template>
    <AppLayout title="Dashboard">
        ...
        <div class="flex justify-end items-center gap-4 py-10">
            <SelectFilter
                :items="filters"
                :active="activeFilter"
        ...
        <table class="w-full border border-gray-200">
            <thead>
                ...
                >
                    ...
                    <td class="text-center">Links Count</td>
            ...
            <tbody>
                ...
                >
                    ...
                    <td class="font-medium text-center">${{ order.price }}</td>
                    <td class="font-medium text-center">
                        {{ order.links.length ?? 0 }}
                    </td>
                    <td class="font-medium text-center">
                        {{ order.project.name ?? 0 }}
                    </td>
