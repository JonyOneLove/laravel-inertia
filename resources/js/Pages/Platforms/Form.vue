...
const savePlatform = () => {
    if (props.platform.id) {
        let routeName = route("platforms.update", props.platform.id);
        form.put(routeName, {
            onSuccess: () => {
                form.reset();
            },
        ...
        let routeName = route("platforms.store");
        form.post(routeName, {
            onSuccess: () => {
                form.reset();
            },
    ...
    <AppLayout>
        <div>
            ...
            >
                ...
                <button
                    @click.prevent="router.visit('/dashboard/platforms')"
